      ...
      shots: [
        {
          ...
          shotType: "wide | medium | close",
          cameraMovement: "static | slow_push | handheld | pan | other",
          sceneDescription: "string - SPECIFIC visual: camera angle + lighting + one action/emotion. No abstract concepts.",
...
function buildPrompt(brand: BrandKit, strategy: StrategySelection): string {
  ...
  parts.push(
    ...
    "",
    "4. sceneDescription (CRITICAL - each shot):",
    "   Each shot description MUST be a specific visual scene, not a concept.",
    "   BAD: 'Show a happy mother with her baby'",
    "   GOOD: 'Close-up of a mother's face breaking into a surprised smile as she opens a package, warm kitchen lighting, shallow depth of field'",
    "   BAD: 'Display the product benefits'",
    "   GOOD: 'Flat lay of branded diaper package next to a price tag crossed out in red, clean white background, bold shadow'",
    "   Rules for sceneDescription:",
    "   - Name the specific camera angle (close-up, wide shot, overhead, POV)",
    "   - Name the lighting (natural window light, ring light, warm kitchen, etc)",
    "   - Name one specific emotion or action happening",
    "   - Never use abstract concepts — always describe what the camera literally sees",
    "   - For UGC shots: always specify 'handheld iPhone style', 'no tripod', 'slightly imperfect framing'",
    "",
    "## Task",
